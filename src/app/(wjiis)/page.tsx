...
export default function HomePage() {
  ...
  return (
    <>
      <DynamicSEO
        title="AJOMAIT - American Journal of Multidisciplinary AI & Technology"
        description="Bridging the gap between theoretical artificial intelligence and practical technological applications."
        keywords={['AI', 'technology', 'multidisciplinary', 'research journal', 'academic publishing', 'AJOMAIT', 'peer review']}
        ogImage="https://ajomait.com/og-image.jpg"
        canonicalUrl="https://ajomait.com"
      />
      <WebsiteSchema
        name="AJOMAIT"
        url="https://ajomait.com"
        description="Bridging the gap between theoretical artificial intelligence and practical technological applications."
        publisher="AJOMAIT"
      />
      <OrganizationSchema
        name="AJOMAIT"
        url="https://ajomait.com"
        logo="https://ajomait.com/ajomait-logo.svg"
        description="AJOMAIT - American Journal of Multidisciplinary AI & Technology"
        contactPoint={{
          email: "editor@ajomait.com",
      ...
      <div className="min-h-screen font-sans">
        ...
        {/* Hero Section */}
        <section className="relative border-b border-slate-200" style={{background: 'linear-gradient(135deg, #1a3d5c 0%, #2d5a7f 100%)'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-8 space-y-6">
                <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold tracking-wide uppercase" style={{background: 'rgba(255,255,255,0.15)', color: '#d4c5a0'}}>
                  ISSN: 3069-5811 (Online)
                </div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight text-white">
                  ...
                  <span style={{color: '#d4a574'}}>Multidisciplinary AI & Technology</span>
                </h1>

                <p className="text-xl max-w-2xl leading-relaxed" style={{color: '#d4c5a0'}}>
                  Bridging the gap between theoretical artificial intelligence and practical technological applications. A premier platform for groundbreaking research.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Link
                    ...
                    onMouseEnter={e => (e.currentTarget.style.background='#c4944f')}
                ...
                <div className="grid grid-cols-3 gap-8 pt-8 max-w-lg" style={{borderTop: '1px solid rgba(255,255,255,0.2)'}}>
                  <div>
                    ...
                    <div className="text-sm font-medium" style={{color: '#d4c5a0'}}>Research Papers</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">{stats.totalAuthors.toLocaleString()}+</div>
                    <div className="text-sm font-medium" style={{color: '#d4c5a0'}}>Contributors</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">AM J</div>
                    <div className="text-sm font-medium" style={{color: '#d4c5a0'}}>Multidisciplinary</div>
                  </div>
                </div>
              </div>
            ...
            {loading ? (
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {latestPapers.map((paper) => (
                  <div key={paper.id} className="group bg-white rounded-lg p-6 border border-slate-200 hover:shadow-md transition-all duration-200" style={{borderTop: '3px solid #1a3d5c'}}>
                    <div className="flex items-start justify-between mb-3">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium" style={{background: '#efe9dc', color: '#1a3d5c'}}>
                        {paper.category}
                      </span>
                    ...
                    <h3 className="font-serif font-bold text-lg mb-2 transition-colors line-clamp-2" style={{color: '#1a3d5c'}}>
                    ...
                    <div className="mb-4 text-xs text-slate-500">
                      <span className="font-semibold" style={{color: '#1a3d5c'}}>Authors:</span> {paper.authors.join(', ')}
                    </div>
        ...
        {/* Why Choose Us */}
        <section className="py-16 border-y border-slate-200" style={{background: '#f5f3ed'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-serif font-bold mb-4" style={{color: '#1a3d5c'}}>Journal Features</h2>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                { icon: Globe, title: 'Global Reach', desc: 'Connecting AI and technology researchers worldwide.' },
                ...
                <div key={index} className="bg-white rounded-lg p-6 shadow-sm" style={{border: '1px solid #d4c5a0', borderTop: '3px solid #d4a574'}}>
                  <feature.icon className="w-8 h-8 mb-4" style={{color: '#1a3d5c'}} />
                  <h3 className="text-lg font-bold mb-2" style={{color: '#1a3d5c'}}>{feature.title}</h3>
        ...
        {/* CTA */}
        <section className="py-16 text-white" style={{background: 'linear-gradient(135deg, #1a3d5c 0%, #2d5a7f 100%)'}}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 text-white">
              Submit Your Research Today
            </h2>
            <p className="mb-8 text-lg" style={{color: '#d4c5a0'}}>
              Join our community of scholars and contribute to advancing AI and technology research.
            </p>
